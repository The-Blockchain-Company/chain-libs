...
/// Optimum Leader consisting of the KES public key and VRF public key
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub struct GenesisOptimumLeader {
    pub kes_public_key: PublicKey<SumEd25519_12>,
    pub vrf_public_key: PublicKey<RistrettoGroup2HashDh>,
}

impl GenesisOptimumLeader {
...
mod tests {
    ...
    impl Arbitrary for GenesisOptimumLeader {
        fn arbitrary<G: Gen>(g: &mut G) -> Self {
            lazy_static! {
