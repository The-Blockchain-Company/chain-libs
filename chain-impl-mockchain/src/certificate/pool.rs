...
use crate::key::{deserialize_public_key, deserialize_signature, GenesisOptimumLeader};
...
pub type GenesisOptimumLeaderHash = DigestOf<Blake2b256, GenesisOptimumLeader>;
...
impl DeserializeFromSlice for PoolRegistration {
    fn deserialize_from_slice(codec: &mut Codec<&[u8]>) -> Result<Self, ReadError> {
        ...
        let keys = GenesisOptimumLeader::deserialize_from_slice(codec)?;
