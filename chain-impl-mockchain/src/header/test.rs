...
use crate::header::{BftProof, BftSignature, Common, GenesisOptimumProof, KesSignature};
...
impl Arbitrary for GenesisOptimumProof {
    fn arbitrary<G: Gen>(g: &mut G) -> Self {
    ...
    fn arbitrary<G: Gen>(g: &mut G) -> Self {
        ...
        match common.block_version {
            ...
            BlockVersion::KesVrfproof => {
                let gp_proof: GenesisOptimumProof = Arbitrary::arbitrary(g);
                hdrbuilder
