...
pub struct Settings {
    ...
    pub consensus_nonce: OptimumNonce,
...
/// Described in Shardagnostic Optimum paper, also referred to as parameter F of phi function
/// Always in range (0, 1]
...
impl Settings {
    pub fn new() -> Self {
        Self {
            ...
            consensus_nonce: OptimumNonce::zero(),
            slots_per_epoch: 1,
    ...
    pub fn try_apply(&self, changes: &ConfigParams) -> Result<Self, update::Error> {
        ...
        for param in changes.iter() {
            match param {
                ...
                ConfigParam::ConsensusGenesisOptimumActiveSlotsCoeff(d) => {
    ...
    pub fn to_config_params(&self) -> ConfigParams {
        ...
        params.push(ConfigParam::ConsensusGenesisOptimumActiveSlotsCoeff(
