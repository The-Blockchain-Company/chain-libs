...
/// OptimumNonce gathered per block
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct OptimumNonce([u8; 32]);
...
impl AsRef<[u8]> for OptimumNonce {
    fn as_ref(&self) -> &[u8] {
        &self.0[..]
    }
}
...
mod test {
    ...
    impl Arbitrary for OptimumNonce {
    ...
    impl Arbitrary for ConsensusEvalContext {
        fn arbitrary<G: Gen>(g: &mut G) -> Self {
            ...
            match n {
                ...
                2 => ConsensusEvalContext::Optimum {
