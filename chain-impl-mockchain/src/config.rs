...
pub enum Tag {
    ...
    #[strum(to_string = "genesis-optimum-param-f")]
    ConsensusGenesisOptimumActiveSlotsCoeff = 8,
...
impl Tag {
    pub fn from_u16(v: u16) -> Option<Self> {
        match v {
            ...
            8 => Some(Tag::ConsensusGenesisOptimumActiveSlotsCoeff),
    ...
    fn from(config_param: &'a ConfigParam) -> Self {
        match config_param {
            ...
            ConfigParam::ConsensusGenesisOptimumActiveSlotsCoeff(_) => {
                Tag::ConsensusGenesisOptimumActiveSlotsCoeff
            }
...
impl DeserializeFromSlice for ConfigParam {
    fn deserialize_from_slice(codec: &mut Codec<&[u8]>) -> Result<Self, ReadError> {
        ...
        match taglen.get_tag()? {
            ...
            Tag::ConsensusGenesisOptimumActiveSlotsCoeff => ConfigParamVariant::from_payload(bytes)
                .map(ConfigParam::ConsensusGenesisOptimumActiveSlotsCoeff),
...
impl Serialize for ConfigParam {
    fn serialize<W: Write>(&self, codec: &mut Codec<W>) -> Result<(), WriteError> {
        ...
        let bytes = match self {
            ...
            ConfigParam::ConsensusGenesisOptimumActiveSlotsCoeff(data) => data.to_payload(),
    ...
    impl Arbitrary for ConfigParam {
        fn arbitrary<G: Gen>(g: &mut G) -> Self {
            match u8::arbitrary(g) % 30 {
                ...
                5 => ConfigParam::ConsensusGenesisOptimumActiveSlotsCoeff(Arbitrary::arbitrary(g)),
