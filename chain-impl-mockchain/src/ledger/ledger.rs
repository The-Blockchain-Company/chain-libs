...
pub enum Block0Error {
    ...
    #[error("Optimum active slot coefficient setting is duplicated in the initial fragment")]
    InitialMessageDuplicateOptimumActiveSlotsCoeff,
    ...
    #[error("Missing optimum active slot coefficient in the initial fragment")]
    InitialMessageNoOptimumActiveSlotsCoeff,
...
pub enum Error {
    ...
    #[error("Optimum active slot coefficient invalid: {error}")]
    OptimumActiveSlotsCoeffInvalid { error: ActiveSlotsCoeffError },
